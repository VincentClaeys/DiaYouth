...
import AllPeptalkSubmissions from "./allPeptalksSubmissions";


const PeptalkSubmissions = () => {
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.welcomeContentContainer}>
          <View>
            <Text style={styles.welcomeText}>Peptalks</Text>
            <Text style={styles.welcomeTextDescription}>
              Bekijk al je ingezonden peptalks.
            </Text>
          </View>
...
export default PeptalkSubmissions;
